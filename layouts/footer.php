<footer class="footer-distributed" style="background-color:#000000">
    <div class="container">
        <div class="footer-left">
            ...
            <!-- <h3> 
                <strong> Call +91 89510 47475 </strong>
            </h3> -->
            <p class="footer-company-name mb-5">© StudioElement. All rights reserved. Copyright 2021</p>
        </div>
    </div>
</footer>