...
<body>
    ...
    <section>
        <div id="carouselExampleSlidesOnly" class="carousel slide " data-bs-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item cara-img bg-img-5 active">
               <div class="cara-text">
    ...
    <section>
        <div class="container procon" style="max-width:55%;">
            <div class="pdspan">
                <span>Modular</span><span style='font-size:13px; color:#e4883a'>&#9632;</span> <span>Kitchen</span>
    ...
    <section>
        <div class="conatiner bgimgpd">
            <div class="text-center">
                <img src="assets/img/bk2.jpg" loading="lazy" alt="" width="80%">
            </div>
        ...
        <div class="conatiner bgimgpd">
            <div class="text-center">
                <img src="assets/img/bk3.jpg" loading="lazy" alt="" width="80%">
            </div>
        ...
        <div class="conatiner bgimgpd">
            <div class="text-center">
                <img src="assets/img/bk4.jpg" loading="lazy" alt="" width="80%">
            </div>
        ...
        <div class="conatiner bgimgpd">
            <div class="text-center">
                <img src="assets/img/bk3" loading="lazy" alt="" width="80%">
            </div>
        ...
        <div class="conatiner bgimgpd">
            <div class="text-center">
                <img src="assets/img/bk5.jpg" loading="lazy" alt="" width="80%">
            </div>
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-md-4 mb-3 ">
                                            <div class="card ">
                                                <img class="img-fluid" alt="100%x280" src="assets/img/31.png" loading="lazy">
                                                <div class="card-body ">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card">
                                                <img class="img-fluid" alt="100%x280" src="assets/img/32.png" loading="lazy">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card">
                                                <img class="img-fluid" alt="100%x280" src="assets/img/33.png" loading="lazy">
                                                <div class="card-body">
                                                    <h4 class="card-title">dreaming midnight</h4>
                                                    <p class="card-text">Sed vel eros quis mauris iaculis imperdiet.
                                                        Pellentrat nec dolor ornare digni at eu risus. Nulla facilisi.
