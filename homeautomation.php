...
<head>
    ...
    <title>Home Automation | Elements</title>
    ...
    <link rel="canonical" href="https://makinginterior.com/projectdetail.php" />
...
<iconify-icon icon="icomoon-free:whatsapp" style="color: white;" width="30"></iconify-icon> </a>
    ...
    <section>
        <div class="container procon" style="max-width:55%;">
            <div class="pdspan">
                <span>Home</span><span style='font-size:13px; color:#e5883d'>&#9632;</span> <span>Automation</span>
                <span style='font-size:13px; color:#e5883d'>&#9632;</span> <span>Products</span>

                <h1 style="padding-bottom:20px">Home Automation</h1>
                <h5 style="padding-top:20px">Smart Living Made Effortless</h5>
                <p>Imagine a home that anticipates your needs, adapts to your preferences, and simplifies your daily routines. With our automation systems, you can effortlessly create custom scenes and schedules, allowing your home to respond intelligently to your commands or even adjust automatically based on time, occupancy, or environmental conditions.</p>
                <h5 style="padding-top:20px">Complete Control</h5>
                <p>Gain full control of your home from anywhere in the world with our intuitive mobile app. Whether you want to adjust the lighting ambiance, set the perfect temperature, or ensure your security systems are active, it's all at your command. Our solutions provide a seamless and secure connection, allowing you to monitor and control your home with peace of mind.</p>
                <h5 style="padding-top:20px">Enhanced Comfort</h5>
                <p> Our automation systems offer more than just convenience; they also enhance comfort, promote energy efficiency, and provide advanced security features. Set the perfect lighting scene for any occasion, optimize energy usage by scheduling temperature adjustments, and enjoy enhanced peace of mind with integrated security cameras, smart locks, and alarm systems.</p>
                <h5 style="padding-top:20px">Tailored to Your Lifestyle</h5>
                <p>We understand that every home is unique, and so are your lifestyle preferences. Our expert team works closely with you to design and customize an automation solution that aligns perfectly with your needs and aspirations. Whether you're seeking a comprehensive smart home integration or specific automation for selected areas, we have the expertise and products to bring your vision to life.</p>
            </div>
        </div>
    </section>
    ...
    <section class="pt-5">
        <div class="container">
            ...
            <div class="container something">
                <div class="row">
                    <div class="col-12">
                        <div id="carouselExampleIndicators2" class="carousel slider" data-ride="carousel">
                            <div class="carousel-inner">
                                            ...
                                            <div class="card ">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <p class="card-text">Sed vel eros quis mauris iaculis imperdiet.
                                                        Pellentrat nec dolor ornare digni at eu risus. Nulla facilisi.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="cara">
                                <a class="carousel-control-prev " href="#carouselExampleIndicators2" role="button" data-slide="prev">
                                    <img src="assets/img/previous.svg" alt="">
