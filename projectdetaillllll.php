...
<head>
    ...
    <title>Project Detail | Simplify Studio</title>
    ...
    <link rel="canonical" href="https://simplifystudio.in/projectdetail.php" />
    ...
    <section>
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item cara-img bg-img-1 active">
                </div>
                <div class="carousel-item cara-img bg-img-2">
                </div>
                <div class="carousel-item cara-img bg-img-3">
                </div>
            </div>
        </div>
    </section>
